...
2. You must install Tesseract OCR (found here: https://github.com/tesseract-ocr/tesseract)
3. In "secret.py" you must replace YOUR_BOT_TOKEN with your own bot token (return: string)
4. The filepaths are linked to my own personal host computer, these will need to be changed depending on your system.
5. Run the "main.py" file in either cmd or your vscode console to initiate the bot.
------------
...
[+] MKV to MP4 : Converts non-embeded MKV into web optimised MP4 files.
------------
